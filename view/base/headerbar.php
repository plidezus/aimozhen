   	  <div style="width:100%; height:20px;">
          <div id="headerbar" style="color:#AAA; float:left;margin:-14px 0 0 0">
            ...
            <?php if ($pagename=="verify"){ echo '<a style="color:#333"';}else{echo '<a';} ?> href="/verify">创作人</a>
            <?php if ($pagename=="discover"){ echo '<a style="color:#333"';}else{echo '<a';} ?> href="/discover">随便看看</a>    
          </div>
          ...
          <?php if ($pagename=="tag") { ?>
            ...
            <div style="color:#AAA; float:right;margin:-14px 30px 0 0"><strong><?=$sitename?>共有 <?=$video_count?> 部原创作品</strong></div>
            <? } else { ?>
